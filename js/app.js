...
var Player = function () {
    ...
    //calculates new location based on board square size
...
Player.prototype.update = function (dt) {
    ...
    //check if player is still in bounds with new coordinates
    if (this.checkInBounds(offset)) {
        this.x = offset.x;
        this.y = offset.y;
    }
    //reset game
...
Player.prototype.checkInBounds = function (o) {
    return ( o.x > 0 && o.x < 500 && o.y < 500);
};
